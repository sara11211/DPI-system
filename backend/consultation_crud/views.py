...
from .models import Consultation, Ordonnance, Medicament,ResumeConsultation,Dpi,Medecin,SoinsInfirmier
from .serializers import ConsultationSerializer, OrdonnanceSerializer,MedicamentSerializer,ResumeConsultationSerializer,DpiSerializer,SoinsInfirmierSerializer
