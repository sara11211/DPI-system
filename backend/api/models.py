...
class Personnel(models.Model):
    users = models.ForeignKey(User, on_delete=models.CASCADE,  related_name='perso')
...
class DPI(models.Model):
    ...
    users = models.ForeignKey(User, on_delete=models.CASCADE, null=False, related_name='dpi')  # dpi must have a user
