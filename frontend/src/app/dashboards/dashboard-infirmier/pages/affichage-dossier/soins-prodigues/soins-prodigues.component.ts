...
export class SoinsProdiguesComponentInfirmier {
  ...
  ngOnInit(): void {
    this.router.events.subscribe(() => {
      this.isModalVisible =
        this.router.url.includes('affichage-soin') ||
        this.router.url.includes('modifier-soin') 
        ;
    });
  }
  ...
  openModalAffichageSoin(id: string): void {
    this.router.navigate(['affichage-soin', id], { relativeTo: this.route });
  }

  openModalModifierSoin(id: string): void {
    this.router.navigate(['modifier-soin', id], { relativeTo: this.route });
  }
}
